...
SELECT 
    ...
    SAFE_CAST(cod AS STRING) id_aeis, # 309 ids únicos de 996 entradas (aprox. 31% das entradas)
    ...
    SAFE_CAST(pavimentos AS STRING) limite_pavimentos_permitidos, # verificar metadado
